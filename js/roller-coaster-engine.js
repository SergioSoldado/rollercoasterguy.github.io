$(document).ready(function() {
    ...
    var tronaldDump = ["PANIC SELLING!!!", "DUMPPP!", "Bitcoin going to 0!! LOLOLOL", "SEGWIT POISON PILL", "LIGHTNING VAPORWARE", "buy da dip", "Ethereum up to 10% off", "Tronald DUMP!", "RIP McAfee's dick"];
    ...
    function updateStatus(open, close) {
        ...
        if (changeAbs >= changeTreshold) {
            $("#roller-coaster-guy").attr("src", "images/munztiger.png");
